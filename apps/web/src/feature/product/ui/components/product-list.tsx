...
export function ProductList({ orgId, teamId }: ProductListProps) {
  ...
  const filtered = useMemo(() => {
    ...
    return (products ?? []).filter((p) => {
      if (groupFilter !== "all" && p.productGroupId !== groupFilter) return false
      if (!q) return true
      return (
  ...
  return (
    <Card className="border border-border/40 bg-card/80 shadow-sm backdrop-blur-sm">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-4">
        ...
        {orgId && (
          <ProductModal orgId={orgId} productGroups={productGroups ?? []}>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end" className="w-40">
                      <ProductModal orgId={orgId ?? ""} product={product} productGroups={productGroups ?? []}>
        ...
        <DialogContent className="sm:max-w-md">
          ...
          <div className="flex gap-2">
            ...
            <Button
              ...
              onClick={() => deleteTarget && deleteMutation.mutate({ organizationId: orgId ?? "", id: deleteTarget })}
            >
